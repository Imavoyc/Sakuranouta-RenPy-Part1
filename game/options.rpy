...
define config.name = _("Sakuranouta_part1")

define config.developer = True
define config.console = True
define config.gl2 = True
define config.layers = ['master','f30x','f39x','transient','screens','overlay' ]
...
游玩的方式是
    ...
    2.从第二部分进入游戏，根据共通线结尾提示的结果，选择不同线路游玩。
    3.重复上述步骤，直到解锁第二，三章 全部 四条线
...
define build.name = "Sakuranouta_part1"
...
define config.save_directory = "Sakuranouta_part1-1619192587"
